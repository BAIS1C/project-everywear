 ...
 * Promoted from modal to full window. Adds song browser sidebar
 * and "Coming Soon" tabs for AI Video and Storyboard features.
 *
...
export default function VidApp(_props: VidAppProps = {}) {
  ...
  return (
    <div className="flex h-full bg-s3 text-white" data-tour="vid.applet-root">
      ...
      <div className="w-56 border-r border-white/[0.06] flex flex-col shrink-0" data-tour="vid.song-list">
          ...
          {songs.length === 0 ? (
            (isLoading || (!hasLoaded && hadSongsHintRef.current)) ? (
              ...
              <div className="px-3 py-6 text-center">
                ...
                <p className="text-[10px] text-white/20 mt-1">Generate music in S³ Gener8</p>
              </div>
            )
          ) : (
            songs.map(song => (
