class KtxDecoder {
    ...
    constructor (context, externalKtxlib) {
        ...
        {
            const globalKtxlib = typeof globalThis !== "undefined" ? globalThis.LIBKTX : undefined;
            if (externalKtxlib === undefined && globalKtxlib !== undefined)
            {
                externalKtxlib = globalKtxlib;
            }
