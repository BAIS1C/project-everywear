...
// Background music is resolved at runtime through the shell/app asset base, not bundled.
const bgm = `${getAssetBase().replace(/\/$/, "")}/sound/background/cc_bgm_balanced.wav`;
