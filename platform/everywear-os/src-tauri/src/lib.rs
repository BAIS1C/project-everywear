...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::kasai::list_installed_skills,
            commands::kasai::list_watched_projects,
            commands::kasai::get_mymory_status,
            ...
            vault_commands::vault_open_item_file,
            vault_commands::vault_open_item_folder,
            vault_commands::vault_open_path_folder,
